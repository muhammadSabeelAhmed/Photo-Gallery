package com.sabeeldev.galleryapp.fragments;
...
import com.sabeeldev.galleryapp.ImageUtils.imageIndicatorListener;
import com.sabeeldev.galleryapp.ImageUtils.recyclerViewPagerImageIndicator;
...
public class pictureBrowserFragment extends Fragment implements imageIndicatorListener {
    ...
    public pictureBrowserFragment(List<Images> allImages, int imagePosition, Context anim) {
        this.allImages = allImages;
        this.position = imagePosition;
        this.animeContx = anim;
    }

    public static pictureBrowserFragment newInstance(List<Images> allImages, int imagePosition, Context anim) {
